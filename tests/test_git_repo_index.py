...
class TestBuildRepoIndex:
    ...
    def test_reads_refs_heads(self, tmp_path, monkeypatch):
        _disable_git_log(monkeypatch)
        _make_repo(
            tmp_path / "proj",
    ...
    def test_reads_packed_refs(self, tmp_path, monkeypatch):
        _disable_git_log(monkeypatch)
        packed = (
    ...
    def test_lists_workflow_files(self, tmp_path, monkeypatch):
        _disable_git_log(monkeypatch)
        _make_repo(
            tmp_path / "proj",
            workflows={
    ...
    def test_does_not_descend_into_git_dir(self, tmp_path, monkeypatch):
    ...
    def test_deduplicates_by_real_path(self, tmp_path, monkeypatch):
    ...
    def test_skips_when_git_binary_absent(self, tmp_path, monkeypatch):
    ...
    def test_collects_unique_recent_emails(self, tmp_path, monkeypatch):
